...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function, addFarmer(), addDistributor(), addRetailer(), addConsumer()", async() => {

        const supplyChain = await SupplyChain.deployed()

        let tx1 = await supplyChain.addFarmer(originFarmerID)
        let tx2 = await supplyChain.addDistributor(distributorID)
        let tx3 = await supplyChain.addRetailer(retailerID)
        let tx4 = await supplyChain.addConsumer(consumerID)
        ...
        // Verify the result
        assert(isFarmer, true, 'Error: This is not farmer')
        assert(isDistributor, true, 'Error: This is not distributor')
        assert(isRetailer, true, 'Error: This is not retailer')
        assert(isConsumer, true, 'Error: This is not consumer')
